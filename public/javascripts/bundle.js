...
var React=require("react"),TodoApp=require("./../../components/index.js"),App=function(){this.start=function(e){setTimeout(function(){React.renderComponent(TodoApp({items:e.items}),document.getElementById("example"));var t=$("#example div:first").attr("data-react-checksum");$(".same span.after").text(t),React.renderComponent(TodoApp({items:e.items+",Test 3"}),document.getElementById("example2"));var t=$("#example2 div:first").attr("data-react-checksum");$(".different span.after").text(t)},1e3)}};window.App=App;
